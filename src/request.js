const requests = {
  ...
  fetchNetflixOriginals: `/discover/tv?${process.env.REACT_APP_API_KEY}&with_networks=213`,
  ...
  fetchRomanceMovies: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_genres=104749`,
  fetchDocumentories: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_genres=99`,
};
